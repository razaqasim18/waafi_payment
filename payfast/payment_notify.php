...
if(!is_file($file)){
   // $contents = $response.'check1 = '.$check1.'check2 ='.$check2.'check3 ='.$check3.'check4 ='.$check4;           // Some simple example content.
    file_put_contents($file, $_SERVER['REQUEST_METHOD']);     // Save our content to the file.
}
...
if($check4) {
    ...
    $username = "digitall_tryptu";
    $password = "digitall_tryptu";
    $dbname = "digitall_tryptu";
    ...
    $sql = "INSERT INTO meat (m_payment_id) VALUES ($m_payment_id)";
